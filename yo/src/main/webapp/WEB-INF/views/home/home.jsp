			...
			<div class="col fill_height">
				...
				<div class="search_tabs_container">
					<div
						...
						<div
							class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
							<img src="resources/images/departure.png" alt="">flights
						</div>
						<div
							class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
							<img src="resources/images/island.png" alt="">trips
						</div>
						<div
							class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
							<img src="resources/images/cruise.png" alt="">cruises
						</div>
						<div
							class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
							<img src="resources/images/diving.png" alt="">activities
						</div>
					</div>
				</div>
...
<div class="cta">
	...
	<div class="cta_background"
		style="background-image: url(resources/images/cta.jpg)"></div>
				...
				<div class="cta_slider_container">
					<div class="owl-carousel owl-theme cta_slider">
						...
						<div class="owl-item cta_item text-center">
							...
							<p class="cta_text">Lorem ipsum dolor sit amet, consectetur
								adipiscing elit. Nullam eu convallis tortor. Suspendisse
								potenti. In faucibus massa arcu, vitae cursus mi hendrerit nec.
								Proin bibendum, augue faucibus tincidunt ultrices, tortor augue
				...
				<div class="test_slider_container">
					<div class="owl-carousel owl-theme test_slider">
						...
						<div class="owl-item">
							<div class="test_item">
								<div class="test_image">
									<img src="resources/images/test_1.jpg"
										alt="https://unsplash.com/@anniegray">
								</div>
								<div class="test_icon">
									<img src="resources/images/backpack.png" alt="">
								</div>
								<div class="test_content_container">
									<div class="test_content">
										...
										<p class="test_quote_text">Nullam eu convallis tortor.
						...
						<div class="owl-item">
							<div class="test_item">
								<div class="test_image">
									<img src="resources/images/test_2.jpg"
										alt="https://unsplash.com/@tschax">
								</div>
								<div class="test_icon">
									<img src="resources/images/island_t.png" alt="">
								</div>
								<div class="test_content_container">
									<div class="test_content">
										<div class="test_item_info">
						...
						<div class="owl-item">
							<div class="test_item">
								<div class="test_image">
									<img src="resources/images/test_3.jpg"
										alt="https://unsplash.com/@seefromthesky">
								</div>
								<div class="test_icon">
									<img src="resources/images/kayak.png" alt="">
								</div>
								<div class="test_content_container">
									<div class="test_content">
										<div class="test_item_info">
	...
	<div class="container">
		...
		<div class="row trending_container">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_1.png"
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_2.png"
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_3.png"
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_4.png"
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_5.png"
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_6.png"
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_7.png"
			...
			<div class="col-lg-3 col-sm-6">
				<div class="trending_item clearfix">
					<div class="trending_image">
						<img src="resources/images/trend_8.png"
...
<div class="contact">
	<div class="contact_background"
		style="background-image: url(resources/images/contact.png)"></div>
