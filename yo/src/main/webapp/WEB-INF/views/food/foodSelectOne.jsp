							...
							<div class="food_info">
								...
								<div class="review_wrap">
									...
									<form name="reviewform" class="reviewform" method="get"
										...
										<input type="text" class="rate" name="rate" id="rate" /> <input
											type="text" name="review_member_email"
											...
											<input type="text" class="form_food_location"
								...
								<div class="location_on_map" style="margin-top:100px">
		...
		function showReview(food_id) {
			...
			$.ajax({
						...
						success : function(result) {
							...
							console.log(result);
							var reveiw = document.querySelector('#print_review');
							...
							for (var i = 0; i < result.length; i++) {
								...
								.createElement('div');
								review_head.setAttribute("style","width:100%; float:left; font-size:20px;");
								var review_head1 = document
										.createElement('div');
								
								review_head1.textContent = result[i].review_member_email;
								
								
								
								
								var review_head2 = document.createElement('div');//여기에 별 찍을거임..
								...
								review_head1.setAttribute("style","float:left;");
								review_head2.setAttribute("style","float:left;");
								...
								review_body.setAttribute("style","height:80px; width:100%; float:left;");

								
								
								var review_content = document.createElement('div');
								review_content.textContent = result[i].review_subject;
								review_content.setAttribute("style","font-size:30px;");
